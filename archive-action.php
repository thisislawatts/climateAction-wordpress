	...
	<div class="<?php echo esc_attr( $container_class ); ?> archive-container">
		<div class="row">
			...
			<div class="nv-index-posts blog col">
				...
				// Output the actions page content.
				// This allows us to have an editable top section for this archive page.
				$actions_page = get_page_by_path( 'actions' );
				echo apply_filters( 'the_content', $actions_page->post_content );
